...
<body>
    ...
    <main>
        <section class="model-nav">
            <ul>
                <li><a href="/posts911">911</a></li>
                <li><a href="/posts">718</a></li>   
                <li><a href="/postsMacan">Macan</a></li>
                <li><a href="/postsTaycan" id="active">Taycan</a></li>
            </ul>
        </section>
        <br>
<center>
        <a class="btn btn-success" href="{{ url('createTaycan') }}">+ Tambahkan Mobil</a>
</center>
        ...
        @foreach ( $posts as $post )
            <div class="model">
                <center>
                <a href="{{ url("/admin/poststaycan/$post->id")}} "><img src="{{ $post->image }}" alt="718 Cayman" id="size-model"></a>
                </center>
                <p>{{$post->name_car}}</p>
                <p>From $ {{ number_format($post->harga) }}</p>
                <a href="{{ url("/postsTaycan/$post->id/edit")}} " class="btn btn-warning">Edit</a>
                <br>
            </div> 
