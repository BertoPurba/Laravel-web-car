    ...
    <main>
        <section class="model-nav">
            <ul>
                ...
                <li><a href="/posts" id="active">718</a></li>   
        ...
        <br>
<center>
        <a class="btn btn-success" href="{{ url('create') }}">+ Tambahkan Mobil</a>
</center>
        ...
        @foreach ( $posts as $post )
            <div class="model">
                <center>
                <a href="{{ url("/admin/posts718/$post->id")}} "><img src="{{ $post->image }}" alt="718 Cayman" id="size-model"></a>
                </center>
                <p>{{$post->name_car}}</p>
