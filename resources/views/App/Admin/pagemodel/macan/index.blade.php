    ...
    <main>
        <section class="model-nav">
            <ul>
                ...
                <li><a href="/postsMacan" id="active">Macan</a></li>
                <li><a href="/postsTaycan">Taycan</a></li>
            </ul>
        </section>
        <br>
<center>
        <a class="btn btn-success" href="{{ url('createMacan') }}">+ Tambahkan Mobil</a>
</center>
        ...
        @foreach ( $posts as $post )
            <div class="model">
                <center>
                <a href="{{ url("/admin/postsmacan/$post->id")}} "><img src="{{ $post->image }}" alt="718 Cayman" id="size-model"></a>
                </center>
                <p>{{$post->name_car}}</p>
                <p>From $ {{ number_format($post->harga) }}</p>
                <a href="{{ url("/postsMacan/$post->id/edit")}} " class="btn btn-warning">Edit</a>
                <br>
            </div> 
