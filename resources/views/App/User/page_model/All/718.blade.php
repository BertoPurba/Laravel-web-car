...
<body>
<header>
    <a href="/model/718"><img src="https://tse2.mm.bing.net/th?id=OIP.rIY7QrJ_LmdIKmc_K3oyIgHaGR&pid=Api&P=0&h=220" alt="Logo" style="width:59px; height: 49px"></a>
        <nav>
            <ul>
                <li><a href="/model/718">Models</a></li>
            </ul>
        </nav>
        <br><br>
    </header>
