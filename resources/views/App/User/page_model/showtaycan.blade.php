    ...
    <main>
        <section class="model-nav">
            <ul>
                ...
                <li><a href="/model/718">718</a></li>   
                <li><a href="/model/macan">Macan</a></li>
                <li><a href="/model/taycan" id="active">Taycan</a></li>
            </ul>
        </section>
        ...
        @foreach ( $posts as $post )
            <div class="model hidden">
                <center>
                <a href="{{ url("/poststaycan/$post->id")}} "><img src="{{ $post->image }}" alt="718 Cayman" id="size-model"></a>
                </center>
                <p>{{$post->name_car}}</p>
